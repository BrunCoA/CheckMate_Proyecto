		...
		<form method="post" id="frm_abml">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="text" name="txt_nombre_asignatura" id="txt_nombre_asignatura" class="form-control" />
					<br />
				</div>
...
<script type="text/javascript" src="ajaxAsignatura.js" language="javascript"></script>
        ...
        <div class="modal-container" id="modal_container">
            <div class="modal">
                ...
                <div class="botonesuwu">
                    <div><button id="openalumno">Soy un alumno</button><button id="openregdocente" style="margin-bottom: 3%; margin-left: 3%; width: 45%; color: #F66B05; height: 40px; border: 0px; background-image: url(css/html-color-codes-color-tutorials-hero.jpg);">Soy un docente</button></div>
                </div>
